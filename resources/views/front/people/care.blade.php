        ...
        <div class="col-right p-10">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h5 class="color_1">1. Hình thức làm việc của các trung tâm gia sư lừa đảo :</h5>
                    <ul class="list_1">
                    ...
                    <h5 class="color_1">2. Mục đích của trung tâm gia sư lừa đảo “nói không thành có”:</h5>
                    <ul class="list_1">
                    ...
                    <h5 class="color_1">3. Các thiệt hại bên phụ huynh phải chịu “tiền mất tật mang”:</h5>
                    <ul class="list_1">
                        <li>Chất lượng dạy của gia sư không đảm bảo.</li>
                        <li>Mất cắp đồ đạc.</li>
                        <li>Con cái của phụ huynh bị kẻ xấu dụ dỗ.</li>
                    </ul>
                    <h5 class="color_1">4. Các thủ thuật qua mặt phụ huynh của trung tâm gia sư lừa đảo:</h5>
                    <ul class="list_1">
                    ...
                    <h5 class="color_1">5. Lời khuyên cho các bậc phụ huynh có con em đang học gia sư:</h5>
                    <ul class="list_1">
