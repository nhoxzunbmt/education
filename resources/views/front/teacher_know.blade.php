                    ...
                    <div class="post_left_section">
                        <div class="post single_post" style="border-bottom: none;">
                            <div class="post_desc">
                                ...
                                <p class="text-c m-b-15"><font class="required">4/.</font> Khi đến nhận lớp, nếu có bất kỳ trở ngại nào (không gặp được Phụ Huynh, thay đổi thời gian học, số lượng học sinh, thay đổi thông tin so với hợp đồng ban đầu...) dẫn đến việc chưa nhận được lớp, Giáo Viên – Sinh Viên phải báo gấp về công ty theo các số điện thoại sau: <font class="required">01674.537.055</font> ngay khi rời nhà Phụ Huynh để Công ty kịp thời xác minh và giải quyết.</p>
